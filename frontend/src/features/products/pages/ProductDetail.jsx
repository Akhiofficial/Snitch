        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col space-y-10">
                      ...
                      <div className="flex flex-wrap gap-4">
                        {isColor && (
                          <button
                            ...
                            className={`group relative flex flex-col items-center w-24 space-y-2 p-2 border transition-all duration-300 ${
                        ...
                        {options.map(option => {
                          ...
                          return (
                            <button
                              ...
                              disabled={!available}
                              onClick={() => handleAttributeSelect(key, option)}
                              className={`px-6 py-3 text-[11px] uppercase tracking-[0.2em] transition-all duration-300 border ${
                                selectedAttributes[key] === option 
            ...
            <div className="space-y-4 pt-10">
                ...
                >
                    {(matchedVariant ? matchedVariant.stock : product.stock) > 0 ? 'Add to Shopping Bag' : 'Sold Out'}
                </button>
