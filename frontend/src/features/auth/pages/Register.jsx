                ...
                <div className="w-full max-w-xl space-y-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-transparent border border-zinc-900 hover:border-zinc-800 text-white font-space font-medium py-4 rounded-lg flex items-center justify-center gap-3 transition-all hover:bg-zinc-900/30 active:scale-[0.98]"
                        >
                            ...
                            <span className="text-[11px] tracking-widest uppercase">Google</span>
                        </button>
                    </form>
