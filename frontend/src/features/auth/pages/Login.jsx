            ...
            <div className="w-full max-w-lg space-y-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button
                        ...
                        type="button"
                        className="w-full bg-transparent border border-zinc-800 hover:border-zinc-700 text-white font-space font-medium py-4 rounded-xl flex items-center justify-center gap-3 transition-all hover:bg-zinc-900/50 active:scale-[0.99]"
                    >
